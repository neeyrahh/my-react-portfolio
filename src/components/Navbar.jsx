...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0f151f] text-gray-300'>
    <div>
      <img src={logo} alt='Logo Image'  className ='h-[70px]' />
        ...
        <ul>
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600'>
            <a className='flex justify-between w-full items-center text-gray-200' href='https://www.linkedin.com/in/somoye-munirat-a5b642194/'>LinkedIn<FaLinkedin size={30}/></a>
          </li>
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#333333]'>
            <a className='flex justify-between w-full items-center text-gray-200' href='https://github.com/neeyrahh'>GitHub<FaGithub size={30}/></a>
          </li>
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#383a3d]'>
            <a className='flex justify-between w-full items-center text-gray-200' href='https://medium.com/@olasunkanmimunirat'>Medium<FaMedium size={30}/></a>
          </li>
        </ul>
        </div>
