  ...
  return (
    <div name='about' className='w-full h-screen  bg-[#0a192f] text-gray-300'>
       ...
       <div className='sm:text-right text-4xl font-bold'>
        ...
        <div>
            <p>I am passionate about building software that improves the lives of people. I specialize in creating software for clients ranging from individual and small businesses. I write my thought and my feelings down,you could learn from it. I share my experience through writing. Hope you don't mind me helping you with my specialization.</p>
        </div>
        </div>
        </div>
     </div>
